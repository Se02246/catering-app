...
router.put('/:id', async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query(
            'UPDATE products SET name = $1, description = $2, menu_description = $3, price_per_kg = $4, image_url = $5, pieces_per_kg = $6, min_order_quantity = $7, order_increment = $8, show_servings = $9, servings_per_unit = $10, is_visible = $11, hide_at = $12, allow_multiple = $13, max_order_quantity = $14, images = $15, is_gluten_free = $16, is_lactose_free = $17, is_vegetarian = $18, is_vegan = $19, is_traditional = $20, is_savory = $21, is_sweet = $22, is_sold_by_piece = $23, price_per_piece = $24, hide_quantity = $25, hide_unit_price = $26, hide_in_menu = $27, hide_from_quotes = $28 WHERE id = $29 RETURNING *',
            [name, description, menu_description || null, price_per_kg, mainImage, pieces_per_kg, min_order_quantity || 1, (order_increment !== undefined && order_increment !== null) ? order_increment : 1, show_servings || false, servings_per_unit, is_visible !== undefined ? is_visible : true, hide_at || null, allow_multiple || false, req.body.max_order_quantity || null, imagesArray, is_gluten_free || false, is_lactose_free || false, is_vegetarian || false, is_vegan || false, is_traditional || false, is_savory || false, is_sweet || false, is_sold_by_piece || false, price_per_piece || null, hide_quantity || false, hide_unit_price || false, hide_in_menu || false, hide_from_quotes !== undefined ? hide_from_quotes : false, id]
        );
