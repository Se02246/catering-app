...
router.post('/', async (req, res) => {
    ...
    try {
        const result = await pool.query(
            ...
            [name, description, price_per_kg, image_url, pieces_per_kg, min_order_quantity || 1, (order_increment !== undefined && order_increment !== null) ? order_increment : 1, show_servings || false, servings_per_unit, is_visible !== undefined ? is_visible : true, req.body.allow_multiple || false]
        );
...
router.put('/:id', async (req, res) => {
    ...
    try {
        const result = await pool.query(
            ...
            [name, description, price_per_kg, image_url, pieces_per_kg, min_order_quantity || 1, (order_increment !== undefined && order_increment !== null) ? order_increment : 1, show_servings || false, servings_per_unit, is_visible !== undefined ? is_visible : true, allow_multiple || false, id]
        );
